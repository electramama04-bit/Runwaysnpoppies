...
# SCRIPT 1 — Satsop POV
**Thu, Sep 10 · 20 sec · Wild Places · No emotional load — this is your warm-up**
...
# SCRIPT 2 — The ocean beat our boat
**Sat, Sep 12 · 15 sec · Small Wonders**

| Time | On screen | You say |
|---|---|---|
| 0:00–0:03 | RC boat hits the first wave<br>`The ocean beat our RC boat in 4 seconds.` | **"Four seconds."** |
| 0:03–0:08 | Wave takes it, Noah's arms go up | **"That's how long our remote control boat lasted against the Pacific Ocean."** |
| 0:08–0:13 | Noah laughing, soaked<br>`Best physics lesson we've had all year.` | **"Nobody had to explain wave energy to him after that. He felt it in his hands."** |
| 0:13–0:15 | Boat washed up on sand | **"Best science lesson we've had all year."** |

**Hook type:** number + defeat. People stay for the loss.

---

# SCRIPT 3 — BLUE TAPE (the anchor)
**Wed, Sep 16 · 60 sec · THE ORIGIN · Face to camera**

**Setup:** Kitchen or garage. Natural light, no ring light. No makeup. Wear the Boeing
...
build the fixtures. That's the sentence that leaves your page.

**Text overlay is mandatory on the hook line and on "They built him a box. I built him a
runway."** Those two carry the reel on mute.

---

# SCRIPT 3-ALT — Blue Tape, text-overlay fallback
**Use if the on-camera version doesn't feel right Wednesday morning. No face, no voice.**
**B-roll only: Ocean Shores waves, slow. One card at a time. Quiet music, no lyrics.**

| Card | Text on screen | Hold |
|---|---|---|
| 1 | My son's fourth-grade teacher put blue tape around his desk. | 4 sec |
| 2 | Before he ever walked in the door on the first day. | 3 sec |
| 3 | He was nine. He hadn't done anything yet. | 4 sec |
| 4 | The tape made a box. His whole body had to stay inside it. | 4 sec |
| 5 | I asked what he'd done. They said he had a lot of energy. | 4 sec |
| 6 | *(cut to Noah on the runway)* So I pulled him out. | 4 sec |
| 7 | I'm a toolmaker at Boeing. I build the fixtures that hold a 777 together. | 5 sec |
| 8 | When a fixture is built wrong, the part comes out wrong. Every time. | 5 sec |
...
# SCRIPT 4 — The box and the runway
**Fri, Sep 18 · 15 sec · Follow-up**
**No school footage. No re-enactment. Present-day happy footage only.**
...
# SCRIPT 5 — FINGER-GUNS / OHIO
**Wed, Sep 23 · 60 sec · THE CULTURAL POST · Face to camera**

**Tone note, and this matters more than anything else in this document: calm, not angry.**
The second you sound angry, you lose every parent who is scared of school shootings — and
that is most parents, and their fear is legitimate. You are not arguing that schools should
stop caring. You are arguing that they've lost the ability to tell a nine-year-old playing
from a nine-year-old in trouble. Say it the way you'd say it to a coworker on second shift.
...
| 0:34–0:40 | **CUT** — Noah's hands: folding a paper airplane, holding the nature journal, on the RC controller | **"These are the same hands."** |
...
# SCRIPT 5-ALT — Finger-Guns, text-overlay fallback
...
| 5 | I'm not telling you that world was perfect. It wasn't. | 4 sec |
| 6 | I'm telling you we knew the difference between a boy playing and a boy in trouble. | 6 sec |
| 7 | *(cut to Noah's hands)* These are the same hands. | 4 sec |
...
# SCRIPT 6 — Stop treating imagination like a threat
**Fri, Sep 25 · 15 sec · Direct to camera · Short and sharp**
...
# SCRIPT 7 — He distracted a Boeing engineer
**Wed, Sep 30 · 20 sec · Runways & Wings**
**Catch this one live if you can. If you can't, the reel works with B-roll + voiceover.**
...
**⚠️ Use the real number of minutes and the real question he actually asked.** If it was
four minutes about landing gear, say four minutes about landing gear. Never inflate — this
is the post where credibility compounds.

---

# SCRIPT 8 — Three things
**Fri, Oct 2 · 30 sec · Listicle · Face + text**

| Time | On screen | You say |
|---|---|---|
| 0:00–0:05 | You<br>`3 things his old school took. Homeschool gave them back in a week.` | **"Three things his old school took away. He got all three back in the first week of homeschool."** |
...
# SCRIPT 9 — The chocolate story (bonus, optional)
**Mon, Oct 5 · 20 sec · Lighter, viral-friendly, standalone**
